...
public class SubscriptionData {
    public static final BigDecimal SUBSCRIPTION_AMOUNT = BigDecimal.valueOf(100);
    ...
    public static final BigDecimal LOW_BALANCE = BigDecimal.valueOf(500).add(SUBSCRIPTION_AMOUNT); // Corrección aquí
